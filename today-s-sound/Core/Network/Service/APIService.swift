...
protocol APIServiceType {
  ...
  func getAlarms(userId: String, deviceSecret: String, page: Int, size: Int) -> AnyPublisher<AlarmListResponse, NetworkError>
}
...
class APIService: APIServiceType {
  ...
  func getAlarms(userId: String, deviceSecret: String, page: Int = 0, size: Int = 10) -> AnyPublisher<AlarmListResponse, NetworkError> {
